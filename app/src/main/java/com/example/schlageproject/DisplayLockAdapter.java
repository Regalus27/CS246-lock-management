...
public class DisplayLockAdapter extends RecyclerView.Adapter<DisplayLockAdapter.ViewHolder> {
    ...
    DisplayLockAdapter(Context context, List<DisplayLock> data) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        DisplayLock lock = mData.get(position);
        holder.myTextView.setText(lock.getName());
    }
